...
The judge should be given the latest live screenshot, the target image, the previous round's screenshot and verdict if any, `.dream-loop/target.json` (for `vertical`), and this prompt:
